    ...
    <div className='Education' id='education'>
        ...
        <div className="bottomEducation">
            <div className="mainedu">
              <div data-aos-duration="1800" data-aos="fade-right" className="edubox">
              ...
              <div data-aos-duration="1800" data-aos="fade-up" className="edubox">
              ...
              <div data-aos-duration="1800" data-aos="fade-left" className="edubox">
